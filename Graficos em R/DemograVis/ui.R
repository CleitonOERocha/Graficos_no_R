...
nomes_territorio <- list("Bacia do Jacuípe",	"Bacia do Paramirim",	"Bacia do Rio Corrente",
                         ...
                         "Velho Chico","Vitória da Conquista")
...
dashboardPagePlus(skin = "blue", title="SEI - Demografia",
                  ...
                  sidebar = dashboardSidebar(collapsed = TRUE,
                    ...
                    sidebarMenu(
                      menuItem("Geral", tabName = "aba1", icon = icon("desktop")),
                      menuItem("Projeção Bahia 2010-2060", tabName = "aba2", icon = icon("chart-line")),
                      menuItem("Censo Demográfico - Municípios", tabName = "aba3", icon = icon("map-marker")),
                      menuItem("Territórios de Identidade", tabName = "aba4", icon = icon("map-marked-alt")),           
                  ...
                  dashboardBody(
                    ...
                    tabItems(
                      ...
                      tabItem(tabName = "aba1", h3("Informações Gerais"), 
                              fluidRow(valueBoxOutput("poptotalgeral", width=3), 
                                       valueBoxOutput("pos_Bahia_Brasil", width=3),
                                       valueBoxOutput("pos_Bahia_NE", width = 3),
                                       valueBoxOutput("tftgeral", width = 3)), br(),
                              fluidRow(width = 12, box(width=NULL,status = "primary", footer = "Fonte: IBGE - Tabela 1.4 - População nos Censos Demográficos,\n segundo as Grandes Regiões e as Unidades da Federação - 1872/2010",
                                           plotOutput("censo_barras"))), br(),
                              fluidRow(
                                column(width=6, box(width=NULL,status = "primary", footer = "IBGE - Projeção (2010 - 2060).",
                                                    plotOutput("piramide_geral"))),
                                column(width=6, box(width=NULL,status = "primary", footer = "IBGE - Projeção (2010 - 2060).", 
                                                    plotOutput("genero_bahia")))
                             )
                      ),
                      #################################################################################
                      #Pagina Projecao - ABA 2
                      #################################################################################
                      tabItem(tabName = "aba2", 
                              ...
                              fluidRow(
                                column(width=6, box(width=NULL,status = "primary", footer = "Fonte: IBGE. Projeção (2010-2060).",
                                       plotOutput("piramide"))),
                                column(width=6, box(width = NULL,status = "primary", footer = "Fonte: IBGE. Projeção (2010-2060).",
                              ...
                              fluidRow(
                                ...
                                fluidRow(width=12, box(width = NULL,status = "primary", footer = "Fonte: IBGE. Projeção (2010-2060).",
                                                       plotOutput("GrafPopTotal"))

                          )), 
                      
                      #################################################################################
                      #Pagina por municipio - aba 3
                      #################################################################################
                      tabItem(tabName = "aba3", h3("Dados Municipais"),
                              fluidRow(
                                column(width=4,
                              ...
                              fluidRow(width=12, box(width=NULL, status = "primary", footer = "Fonte: IBGE. Censo Demográfico",
                                                     title = paste("Mapa da população, por Município."),
                                                     leafletOutput("mapa_ba_mun", height = 500))), br(),
                               fluidRow(
                                column(width=6, box(width=NULL,status = "primary", footer = "Fonte: IBGE. Censo Demográfico",
                      ...
                      #################################################################################
                      #
                      # Pagina Territorio de Identidade - ABA 4
                      #
                      #################################################################################

                      tabItem(tabName = "aba4", h3("Dados sobre Territorios de Identidade"),
                              fluidRow(
                                column(width=4,
                              ...
                              fluidRow(width=12, box(width=NULL, status = "primary", footer = "Fonte: IBGE. Censo Demográfico",
                                                     title = paste("Mapa da população, por Território de Identidade."),
                                                     leafletOutput("mapa_bahia"))), br(),
                              fluidRow(
                                column(width=6, box(width=NULL,status = "primary", footer = "Fonte: IBGE. Censo Demográfico",
